...
Payment assets support cryptocurrencies right now. And the detailed information about payment assets, you can refer to this [payment-assets API](/developers/api/assets/payment-assets).
...
Please always use the [payment-assets API](/developers/api/assets/payment-assets) to get assets' UUID and check for all supported assets.
:::
